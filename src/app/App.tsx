...
function IconCheckmark() { return <svg width="14" height="12" viewBox="0 0 14 12" fill="none"><path d="M1 6.5l4 4 8-10" stroke="#0076FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>; }
function IconChevronDown({ open }: { open: boolean }) { return <svg width="12" height="12" viewBox="0 0 12 12" fill="none" style={{ transform: open ? "rotate(180deg)" : "rotate(0deg)", transition: "transform 0.3s" }}><path d="M2 4l4 4 4-4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>; }
function IconHome() { return <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/><path d="M9 22v-7h6v7" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/></svg>; }
function IconKey() { return <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M21 2l-9 13m0 0l-6 8m6-8H2" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><circle cx="17" cy="5" r="2" fill="currentColor"/></svg>; }
function IconBuilding() { return <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><rect x="4" y="2" width="16" height="20" rx="2" stroke="currentColor" strokeWidth="2"/><path d="M8 6h8M8 10h8M8 14h8M8 18h8" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/></svg>; }
function IconHandshake() { return <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M17 10c1.1 0 1.99-.9 1.99-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zM10 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-3.29.5-4.77 1.5-1.3 1-2.23 3-2.23 5v5h18v-5c0-2-1-3.9-2.3-5-1.48-1-3.67-1.5-4.77-1.5-2.5 0-4.5 1.5-5 1.5s-2.5-1.5-5-1.5z" fill="currentColor"/></svg>; }
function IconBed() { return <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M20 10c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2h-2V1h-2v1H8V1H6v1H4c-1.1 0-2 .9-2 2v4c0 1.1.9 2 2 2h16zm0-7h2v4h-2V3z"/><path d="M4 13c0-1.1.9-2 2-2h12c1.1 0 2 .9 2 2v8H4v-8z"/></svg>; }
function IconBath() { return <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v11c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-2 5h-4V5h4v2z"/><path d="M2 20h20v2H2z"/></svg>; }
function IconArea() { return <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><rect x="3" y="3" width="18" height="18" rx="2" stroke="currentColor" strokeWidth="2" fill="none"/></svg>; }
...
const properties: Property[] = [
  { id: 1, type: "Na sprzedaż", price: "1 950 000 zł", title: "Nowoczesna willa Greenwood", address: "ul. Dębowa 14, Piaseczno", beds: 4, baths: 3, area: "204 m²", img: "https://images.unsplash.com/photo-1613490493576-7fde63acd811?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwyfHxtb2Rlcm4lMjBob3VzZSUyMGV4dGVyaW9yJTIwcmVhbCUyMGVzdGF0ZXxlbnwxfHx8fDE3ODA2Njc2NzF8MA&ixlib=rb-4.1.0&q=80&w=800" },
  { id: 2, type: "Na wynajem", price: "5 800 zł/mies.", title: "Luksusowy apartament Śródmieście", address: "Al. Jerozolimskie 65A, Warszawa", beds: 2, baths: 2, area: "72 m²", img: "https://images.unsplash.com/photo-1564078516393-cf04bd966897?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjBhcGFydG1lbnQlMjBpbnRlcmlvciUyMGxpdmluZyUyMHJvb218ZW58MXx8fHwxNzgwNjE4MDE5fDA&ixlib=rb-4.1.0&q=80&w=800" },
  { id: 3, type: "Na sprzedaż", price: "3 100 000 zł", title: "Rodzinny dom nad rzeką", address: "ul. Wiślana 88, Konstancin", beds: 5, baths: 4, area: "310 m²", img: "https://images.unsplash.com/photo-1628012209120-d9db7abf7eab?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwzfHxtb2Rlcm4lMjBob3VzZSUyMGV4dGVyaW9yJTIwcmVhbCUyMGVzdGF0ZXxlbnwxfHx8fDE3ODA2Njc2NzF8MA&ixlib=rb-4.1.0&q=80&w=800" },
  { id: 4, type: "Na wynajem", price: "2 900 zł/mies.", title: "Kawalerka z tarasem", address: "ul. Kasztanowa 7, Wrocław", beds: 1, baths: 1, area: "38 m²", img: "https://images.unsplash.com/photo-1600494448850-6013c64ba722?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwyfHxsdXh1cnklMjBhcGFydG1lbnQlMjBpbnRlcmlvciUyMGxpdmluZyUyMHJvb208ZW58MXx8fHwxNzgwNjE4MDE5fDA&ixlib=rb-4.1.0&q=80&w=800" },
  { id: 5, type: "Na sprzedaż", price: "5 800 000 zł", title: "Willa z basenem Palmview", address: "ul. Słoneczna 220, Józefosław", beds: 6, baths: 5, area: "480 m²", img: "https://images.unsplash.com/photo-1670589953882-b94c9cb380f5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHw0fHxtb2Rlcm4lMjBob3VzZSUyMGV4dGVyaW9yJTIwcmVhbCUyMGVzdGF0ZXxlbnwxfHx8fDE3ODA2Njc2NzF8MA&ixlib=rb-4.1.0&q=80&w=800" },
  { id: 6, type: "Na wynajem", price: "4 200 zł/mies.", title: "Nowoczesny penthouse", address: "ul. Wieżowa 1, piętro 18, Kraków", beds: 2, baths: 2, area: "95 m²", img: "https://images.unsplash.com/photo-1738168246881-40f35f8aba0a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwzfHxsdXh1cnklMjBhcGFydG1lbnQlMjBpbnRlcmlvciUyMGxpdmluZyUyMHJvb208ZW58MXx8fHwxNzgwNjE4MDE5fDA&ixlib=rb-4.1.0&q=80&w=800" },
];

const testimonials: Testimonial[] = [
  { quote: "HomeKey Realty pomogła nam sprzedać dom powyżej ceny wywoławczej w zaledwie tydzień. James był profesjonalny, szybki i szczerze dbał o nasze interesy.", name: "Dawid i Kasia Kowalski", role: "Sprzedający, Piaseczno" },
  { quote: "Sophie znalazła nam idealne mieszkanie w centrum w ciągu kilku dni. Cały proces był transparentny i bezstresowy. Gorąco polecam!", name: "Laura Wiśniewska", role: "Najemca, Śródmieście" },
  { quote: "Dzięki poradom Marii znacząco rozbudowałem swój portfel nieruchomości. Jej znajomość rynku i dostęp do ofert poza rynkiem to prawdziwa przewaga.", name: "Michał Osei", role: "Inwestor nieruchomościowy" },
];
...
const faqs: FAQ[] = [
  { q: "Jak zacząć proces kupna nieruchomości?", a: "Zacznij od uzyskania wstępnej zdolności kredytowej i skontaktowania się z naszym agentem. Pomożemy określić budżet, wyszukamy odpowiednie oferty, umówimy oglądania i przeprowadzimy przez cały proces zakupu." },
  { q: "Jakie dokumenty są potrzebne do sprzedaży nieruchomości?", a: "Potrzebujesz m.in. aktu notarialnego, zaświadczenia o niezaleganiu z podatkami, ostatnich rachunków za media oraz dowodu osobistego. Nasz agent przygotuje kompletną listę dopasowaną do Twojej sytuacji." },
  { q: "Jak długo trwa sprzedaż nieruchomości?", a: "Przy właściwej cenie większość nieruchomości w naszym regionie trafia pod umowę w ciągu 2–6 tygodni. Nasza strategia marketingowa — profesjonalne zdjęcia, obecność na portalach i sieć nabywców — zapewnia maksymalne zainteresowanie." },
  { q: "Czy pomagacie też przy wynajmie nieruchomości?", a: "Tak. Obsługujemy cały proces: weryfikację najemców, sporządzenie umowy, przeglądy techniczne i bieżące zarządzanie. Pomagamy zarówno właścicielom, jak i osobom szukającym lokalu." },
  { q: "Czy bezpłatna wycena nieruchomości czegoś mnie zobowiązuje?", a: "Nie. Wycena jest całkowicie bezpłatna i bez zobowiązań. Skontaktuj się z nami, a nasz agent umówi wizytę w dogodnym terminie." },
  { q: "Jak wygląda Wasza prowizja?", a: "Prowizja jest naliczana jako procent od ostatecznej ceny transakcji i płatna wyłącznie po jej pomyślnym zakończeniu. Skontaktuj się z nami, aby poznać szczegółowy cennik — stawiamy na pełną transparentność." },
];

const plans: PricingPlan[] = [
  { name: "Start", price: "Bezpłatny", sub: "Idealne na początek", features: ["Prezentacja oferty na stronie", "Konsultacja z agentem", "Wsparcie e-mail", "Raport rynkowy"], unavailable: ["Dedykowany agent", "Profesjonalna fotografia"], cta: "Zacznij teraz", highlight: false },
  { name: "Standard", price: "199 zł", sub: "Najpopularniejszy wybór", features: ["Wszystko z Start", "Dedykowany agent", "Profesjonalna fotografia", "Promocja w social media", "Cotygodniowe raporty"], unavailable: ["Priorytetowe wyróżnienie oferty"], cta: "Wybierz Standard", highlight: true },
  { name: "Premium", price: "499 zł", sub: "Pełna obsługa", features: ["Wszystko ze Standard", "Priorytetowe wyróżnienie oferty", "Wideo-tour nieruchomości", "Konsultacja prawna", "Home staging", "Dostęp 24/7"], unavailable: [], cta: "Wybierz Premium", highlight: false },
];
    ...
    <section ref={ref} id="hero" className="relative min-h-[520px] md:min-h-[620px] flex items-center">
      ...
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 py-14 md:py-20" style={{ fontFamily: "'DM Sans', sans-serif" }}>
        <div className={`max-w-xl transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          <p className="text-white/70 uppercase tracking-widest mb-3" style={{ fontSize: 12, fontWeight: 700 }}>HomeKey Realty</p>
          <h1 className="text-white mb-5" style={{ fontSize: "clamp(34px, 6vw, 60px)", fontWeight: 700, lineHeight: 1.1, letterSpacing: -1 }}>Znajdź swój<br />wymarzony dom</h1>
          <p className="text-white/80 mb-8" style={{ fontSize: "clamp(15px,2vw,18px)", lineHeight: 1.7 }}>Łączymy kupujących, sprzedających i najemców z idealnymi nieruchomościami. Szybko, uczciwie i po ludzku.</p>
          <div className="bg-white rounded-[4px] p-4 shadow-xl">
            <div className="flex gap-1.5 mb-3">
              {(["buy", "rent"] as const).map((t) => (
                <button key={t} onClick={() => setType(t)} className="px-4 h-8 rounded-[3px] transition-all" style={{ background: type === t ? "#0076FF" : "#f0f0f0", color: type === t ? "#fff" : "#555", fontWeight: 700, fontSize: 13 }}>
                  {t === "buy" ? "Kup" : "Wynajmij"}
                </button>
              ))}
            </div>
            <div className="flex gap-2 flex-col sm:flex-row">
              <div className="flex-1 flex items-center border border-[#dcdcdc] rounded-[3px] px-3 h-10 gap-2 min-w-0">
                ...
                <input value={searchVal} onChange={(e) => setSearchVal(e.target.value)} placeholder="Miasto, dzielnica lub kod pocztowy…" className="flex-1 outline-none bg-transparent min-w-0" style={{ fontSize: 14 }} />
              </div>
              <button onClick={() => onNav("properties")} className="h-10 px-4 rounded-[3px] text-white shrink-0" style={{ background: "#0076FF", fontWeight: 700, fontSize: 14 }}>Szukaj</button>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-5 mb-8 md:mb-10">
          ...
          <div className="flex gap-1.5 flex-wrap">
            {[{ key: "all", label: "Wszystkie" }, { key: "sale", label: "Na sprzedaż" }, { key: "rent", label: "Na wynajem" }].map((f) => (
              <button key={f.key} onClick={() => setFilter(f.key as typeof filter)} className="h-9 px-4 rounded-[3px] transition-all" style={{ background: filter === f.key ? "#0076FF" : "#fff", color: filter === f.key ? "#fff" : "#555", border: `1px solid ${filter === f.key ? "#0076FF" : "#dcdcdc"}`, fontWeight: 600, fontSize: 13 }}>
                {f.label}
              </button>
            ))}
          </div>
...
function Testimonials() {
  ...
  return (
    <section ref={ref} className="py-14 md:py-20" style={{ background: "#f0f4ff", fontFamily: "'DM Sans', sans-serif" }}>
      <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
        <p className="uppercase tracking-widest mb-2" style={{ color: "#0076FF", fontSize: 12, fontWeight: 700 }}>Opinie klientów</p>
        <h2 className="text-[#333] mb-10" style={{ fontSize: "clamp(24px,3vw,36px)", fontWeight: 700 }}>Co mówią nasi klienci</h2>
        <blockquote className={`text-[#333] mb-6 transition-all duration-500 ${isVisible ? "opacity-100" : "opacity-0"}`} style={{ fontSize: "clamp(15px,1.8vw,19px)", lineHeight: 1.75, fontStyle: "italic", minHeight: 96 }}>
          „{t.quote}"
        </blockquote>
...
function Team() {
  ...
  return (
    <section ref={ref} id="team" className="py-14 md:py-20 bg-white" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className={`max-w-xl mb-10 md:mb-12 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          <p className="uppercase tracking-widest mb-2" style={{ color: "#0076FF", fontSize: 12, fontWeight: 700 }}>Nasi eksperci</p>
          <h2 className="text-[#333] mb-3" style={{ fontSize: "clamp(26px,4vw,40px)", fontWeight: 700, lineHeight: 1.2 }}>Poznaj zespół</h2>
          <p className="text-[#999]" style={{ fontSize: "clamp(15px,1.5vw,17px)", lineHeight: 1.7 }}>Licencjonowani agenci z głęboką znajomością lokalnego rynku i pełnym zaangażowaniem w Twój sukces.</p>
        </div>
...
function FAQ() {
  ...
  return (
    <section ref={ref} id="faq" className="py-14 md:py-20 bg-white" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-16 items-start">
          <div className={`lg:col-span-2 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            ...
            <h2 className="text-[#333] mb-3" style={{ fontSize: "clamp(26px,4vw,40px)", fontWeight: 700, lineHeight: 1.2 }}>Często zadawane pytania</h2>
            <p className="text-[#999] mb-8" style={{ fontSize: "clamp(14px,1.5vw,16px)", lineHeight: 1.7 }}>Nie znalazłeś odpowiedzi? Zadzwoń lub napisz — odpowiemy w ciągu 24 godzin.</p>
            <div className="grid grid-cols-3 sm:grid-cols-3 gap-3">
              {[{ value: "1 200+", label: "Sprzedanych" }, { value: "500+", label: "Klientów" }, { value: "15 lat", label: "Doświadczenia" }].map((s) => (
          ...
          <div className={`lg:col-span-3 space-y-2.5 transition-all duration-1000 ${isVisible ? "opacity-100" : "opacity-0"}`}>
            {faqs.map((f, i) => (
              <div key={i} className="border rounded-[4px] overflow-hidden transition-colors" style={{ borderColor: open === i ? "#0076FF" : "#eee" }}>
                <button onClick={() => setOpen(open === i ? null : i)} className="w-full flex items-center justify-between px-4 py-4 text-left gap-3">
...
function Plans({ onNav }: { onNav: (id: string) => void }) {
  ...
  return (
    <section ref={ref} className="py-14 md:py-20" style={{ background: "#f7f7f7", fontFamily: "'DM Sans', sans-serif" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className={`text-center mb-10 md:mb-12 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          ...
          <p className="text-[#999] max-w-lg mx-auto" style={{ fontSize: "clamp(14px,1.5vw,16px)", lineHeight: 1.7 }}>Wybierz pakiet dopasowany do Twoich potrzeb. Każdy obejmuje dostęp do pełnej bazy ofert i wsparcie agenta.</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          {plans.map((p, i) => (
            <div key={p.name} className={`rounded-[4px] overflow-hidden bg-white transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`} style={{ border: p.highlight ? "2px solid #0076FF" : "1px solid #eee", boxShadow: p.highlight ? "0 8px 32px rgba(0,118,255,0.1)" : "none", transitionDelay: isVisible ? `${i * 150}ms` : "0ms" }}>
              {p.highlight && <div className="py-1.5 text-center text-white" style={{ background: "#0076FF", fontSize: 11, fontWeight: 700, letterSpacing: 1 }}>NAJPOPULARNIEJSZY</div>}
              <div className="p-6">
                ...
                <button onClick={() => onNav("contact")} className="w-full h-10 rounded-[3px] transition-opacity hover:opacity-90" style={{ background: p.highlight ? "#0076FF" : "transparent", color: p.highlight ? "#fff" : "#0076FF", border: p.highlight ? "none" : "1.5px solid #0076FF", fontWeight: 700, fontSize: 14 }}>
                  {p.cta}
                </button>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
          <div className={`transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            ...
            <h2 className="text-[#333] mb-3" style={{ fontSize: "clamp(26px,4vw,40px)", fontWeight: 700, lineHeight: 1.2 }}>Znajdźmy razem idealną nieruchomość</h2>
            <p className="text-[#999] mb-8" style={{ fontSize: "clamp(14px,1.5vw,16px)", lineHeight: 1.7 }}>Niezależnie czy planujesz kupno, sprzedaż czy najem — nasz zespół jest do Twojej dyspozycji. Oddzwonimy w ciągu 24 godzin.</p>
          ...
          <div className={`transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            {submitted ? (
              <div className="h-full flex flex-col items-center justify-center text-center py-12 animate-in fade-in zoom-in">
                ...
                <button onClick={handleReset} className="mt-5 h-10 px-6 rounded-[3px] text-white" style={{ background: "#0076FF", fontWeight: 700, fontSize: 14 }}>
                  Wyślij kolejną
                </button>
              </div>
            ) : (
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input placeholder="Jan Kowalski" className={`w-full h-11 border rounded-[3px] px-3 outline-none focus:border-[#0076FF] transition-colors bg-white ${form.formState.errors.name ? "border-red-500" : "border-[#dcdcdc]"}`} style={{ fontSize: 14 }} {...form.register("name")} />
                  ...
                  <div>
                    ...
                    <input type="email" placeholder="jan@example.pl" className={`w-full h-11 border rounded-[3px] px-3 outline-none focus:border-[#0076FF] transition-colors bg-white ${form.formState.errors.email ? "border-red-500" : "border-[#dcdcdc]"}`} style={{ fontSize: 14 }} {...form.register("email")} />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input placeholder="+48 600 000 000" className={`w-full h-11 border rounded-[3px] px-3 outline-none focus:border-[#0076FF] transition-colors bg-white ${form.formState.errors.phone ? "border-red-500" : "border-[#dcdcdc]"}`} style={{ fontSize: 14 }} {...form.register("phone")} />
                  ...
                  <div>
                    ...
                    <select className={`w-full h-11 border rounded-[3px] px-3 outline-none focus:border-[#0076FF] transition-colors bg-white ${form.formState.errors.interest ? "border-red-500" : "border-[#dcdcdc]"}`} style={{ fontSize: 14, color: "#333" }} {...form.register("interest")}>
                ...
                <div>
                  ...
                  <textarea placeholder="Powiedz nam, czego szukasz…" rows={5} className={`w-full border rounded-[3px] px-3 py-3 outline-none focus:border-[#0076FF] transition-colors resize-none bg-white ${form.formState.errors.message ? "border-red-500" : "border-[#dcdcdc]"}`} style={{ fontSize: 14 }} {...form.register("message")} />
                  {form.formState.errors.message && <p className="text-red-500 text-sm mt-1">{form.formState.errors.message.message}</p>}
                </div>
                <button type="submit" disabled={isSubmitting} className="w-full h-12 rounded-[3px] text-white hover:opacity-90 transition-opacity disabled:opacity-50" style={{ background: "#0076FF", fontWeight: 700, fontSize: 15 }}>
                  {isSubmitting ? "Wysyłanie…" : "Wyślij wiadomość"}
                </button>
                <p className="text-[#999] text-center" style={{ fontSize: 12 }}>Odpiszemy w ciągu 24 godzin. Twoje dane są bezpieczne.</p>
              </form>
            )}
          </div>
        </div>
...
function Footer({ onNav }: { onNav: (id: string) => void }) {
  ...
  return (
    <footer className="bg-[#1a2d45]" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14 md:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          <div>
            <div className="mb-4">
              <span style={{ color: "#0076FF", fontWeight: 700, fontSize: 18 }}>HomeKey</span>
              <span style={{ color: "#fff", fontWeight: 700, fontSize: 18 }}>Realty</span>
            </div>
            <p className="text-white/60" style={{ fontSize: 13, lineHeight: 1.6 }}>Twoim partnerem w znalezieniu idealnej nieruchomości. Od kupna do sprzedaży, jesteśmy tutaj dla Ciebie.</p>
          </div>
          <div>
            <p className="text-white mb-4 uppercase tracking-wider" style={{ fontSize: 11, fontWeight: 700 }}>Produkty</p>
            {["Kup nieruchomość", "Sprzedaj nieruchomość", "Wynajmij nieruchomość"].map((l) => (
              <button key={l} className="block text-white/60 hover:text-[#0076FF] transition-colors mb-2" style={{ fontSize: 13 }}>
                {l}
              </button>
            ))}
          </div>
          <div>
            <p className="text-white mb-4 uppercase tracking-wider" style={{ fontSize: 11, fontWeight: 700 }}>Firma</p>
            {["O nas", "Blog", "Kariera", "Kontakt"].map((l) => (
              <button key={l} className="block text-white/60 hover:text-[#0076FF] transition-colors mb-2" style={{ fontSize: 13 }}>
                {l}
              </button>
            ))}
          ...
          <div>
            <p className="text-white mb-3 uppercase tracking-wider" style={{ fontSize: 11, fontWeight: 700 }}>Newsletter</p>
            <p className="text-white/60 mb-4" style={{ fontSize: 13, lineHeight: 1.6 }}>Nowe oferty i aktualności rynkowe prosto na Twój e-mail.</p>
            {subscribed ? (
              <p style={{ color: "#0076FF", fontSize: 14, fontWeight: 700 }}>✓ Zapisano!</p>
            ) : (
              <div className="flex gap-2">
                <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Twój e-mail" className="flex-1 h-10 border border-[#dcdcdc] rounded-[3px] px-3 outline-none focus:border-[#0076FF] bg-white transition-colors min-w-0" style={{ fontSize: 13 }} />
                <button onClick={() => email && setSubscribed(true)} className="h-10 px-3 rounded-[3px] text-white shrink-0" style={{ background: "#0076FF", fontWeight: 700, fontSize: 13 }}>
                  Zapisz
                </button>
              </div>
            )}
        ...
        <div className="border-t border-[#dcdcdc]">
          <div className="py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
            <p className="text-white/60" style={{ fontSize: 12 }}>© 2026 HomeKey Realty. Wszelkie prawa zastrzeżone.</p>
            <div className="flex gap-4 flex-wrap justify-center">
              {["Polityka prywatności", "Regulamin", "Cookies"].map((l) => (
                <button key={l} className="text-white/60 hover:text-[#0076FF] transition-colors" style={{ fontSize: 12 }}>
                  {l}
                </button>
              ))}
            </div>
